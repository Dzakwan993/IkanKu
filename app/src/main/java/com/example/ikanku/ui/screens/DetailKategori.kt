...
@Composable
fun DeliveryDetailScreen(onBackClick: () -> Unit, navController: NavController) {
...
//
            ...
            elevation = CardDefaults.cardElevation(
                defaultElevation = 8.dp // Mengatur tinggi elevation
            )
        ) {
            Column(
                modifier = Modifier
...
fun PreviewDeliveryDetailScreen() {
    ...
    DeliveryDetailScreen(onBackClick = { /* Handle back action */ }, navController = navController)
}
