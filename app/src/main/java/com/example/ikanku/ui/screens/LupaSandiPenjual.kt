...
@Composable
fun ForgotPasswordPenjualScreen(navController: NavController) {
...
@Composable
fun ForgotPasswordPenjualScreenPreview() {
    val navController = rememberNavController()
    ForgotPasswordPenjualScreen(navController = navController)
}
